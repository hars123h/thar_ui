...
const Withdrawal = () => {
    ...
    useEffect(() => {
        ...
        getDetails();
        document.body.style.backgroundColor = "rgb(186 14 28)";
    ...
    return (
        <div className='bg-red-800 flex flex-col  sm:h-[1000px] md:h-[950px] relative'>
            ...
            <div className="part1 bg-[#d3d6fe] p-3 rounded-lg mx-3 mt-5">
                <div className='text-red-800 px-2 my-1  rounded-full border border-red-800 inline'>Withdrawal Fee {amountDetails.withdrawal_fee}% | Rs.{(Number(wamount) - (Number(amountDetails.withdrawal_fee) * Number(wamount) / 100))}</div>
                ...
                <div className='flex items-center justify-start gap-2 my-1'>
                    <div className="balance text-red-800 text-sm">Balance &#8377; {balance}</div>
                    <div onClick={handleWithdrawalAll} className="withdraw text-red-800 text-sm cursor-pointer">Withdraw all</div>
                </div>
            </div>
            ...
            <div className='flex  w-full'>
                <button onClick={handleLastButton} className='bg-red-600 text-white text-lg mt-5 mb-20 rounded-lg shadow-md block w-full py-2 shadow-gray-100 mx-2'>Confirm</button>
            </div>
