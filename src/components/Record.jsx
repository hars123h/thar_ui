...
const Record = () => {
    ...
    return (
        <div className=' bg-red-800 pb-3 sm:h-[1000px] md:h-screen h-screen'>
            ...
            {/* [#bfdbf5] */}
            <div className='flex flex-wrap items-center justify-between py-2 px-4 bg-red-500 border-b border-gray-400'>
            ...
            {/* [#bce4ed] */}
            <div className='records w-full flex bg-red-500 font-normal items-center border-b border-gray-400'>
                <div className={`h-[40px] cursor-pointer flex items-center justify-center w-1/3 text-center ${currentRecord === 'recharges' ? 'border-b-2 border-red-800 text-white' : ''}`} onClick={() => setCurrentRecord('recharges')}>Recharge</div>
                <div className={`h-[40px] cursor-pointer flex items-center justify-center w-1/3 text-center ${currentRecord === 'withdrawals' ? 'border-b-2 border-red-800 text-white' : ''}`} onClick={() => setCurrentRecord('withdrawals')}>Withdrawls</div>
                <div className={`h-[40px] cursor-pointer flex items-center justify-center w-1/3 text-center ${currentRecord === 'all' ? 'border-b-2 border-red-800 text-white' : ''}`} onClick={() => setCurrentRecord('all')}>All Types</div>
            </div>
