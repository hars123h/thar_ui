...
const Recharge = () => {
    ...
    return (
        <div className='bg-red-500 h-screen relative'>
            ...
            <div className="options text-center  text-white flex  bg-red-500 text-md  font-normal mb-2 py-2 items-center px-2">
            ...
            <div className="cnf_recharge w-4/5 mx-auto mt-10">
                <button onClick={handleRecharge} className='w-full bg-red-600 py-2 rounded-md text-white text-lg shadow-customShadow shadow-gray-50'>Confirm Recharge</button>
            </div>
